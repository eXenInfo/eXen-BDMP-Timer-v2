...
// idle | prep | running | rep_pause | finished
// EPP-Zustände:
...
export const useTimerStore = defineStore('timer', () => {
  ...
  const isRunning = computed(() => ['running', 'epp_running_fixed', 'epp_running_open', 'prep', 'epp_prep'].includes(state.value))
  const isPaused = computed(() => state.value === 'epp_paused')
